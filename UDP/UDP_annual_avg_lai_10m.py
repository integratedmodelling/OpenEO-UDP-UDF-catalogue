"""
UDP to generate an annual average LAI in high resolution (10m) from Seninel-2
...
cube = cube.apply(lambda x: if_(and_(x >= 0, x <= 250), x * 0.04))
...
description = """
Given a year and area of interest, returns an annual mean composite of LAI (https://docs.terrascope.be/DataProducts/Sentinel-2/references/VITO_S2_ATBD_S2_NDVI_BIOPAR_V200.pdf).
"""

spec = build_process_dict(
    process_id="udp_annual_avg_lai_10m",
    summary="Annual mean composite of Sentinel-2 LAI. Returns a single band RasterCube.",
