"""
UDP to generate an annual average FCOVER in high resolution (10m) from Seninel-2
...
description = """
Given a year and area of interest, returns an annual mean composite of FCOVER (https://docs.terrascope.be/DataProducts/Sentinel-2/references/VITO_S2_ATBD_S2_NDVI_BIOPAR_V200.pdf).
"""

spec = build_process_dict(
    process_id="udp_annual_avg_fcover_10m",
    summary="Annual mean composite of Sentinel-2 FCOVER. Returns a single band RasterCube.",
