"""
UDP to generate an annual average NDVI in high resolution (10m) from Seninel-2
...
cube = cube.apply(lambda x: if_(and_(x >= 0, x <= 250), (x * 0.004) - 0.08))
...
description = """
Given a year and area of interest, returns an annual mean composite of NDVI (https://docs.terrascope.be/DataProducts/Sentinel-2/references/VITO_S2_ATBD_S2_NDVI_BIOPAR_V200.pdf).
"""
